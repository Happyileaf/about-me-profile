...
const SUBSECTIONS: ExpSubsection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        role: "招聘管理系统",
        date: "2023年06月 — 2023年10月",
        bullets: [
          "【项目介绍】招聘业务场景一体化的管理系统，覆盖应聘者、人才、面试、背调等全业务流程。",
          "【技术栈】React，React Hooks，Redux，TypeScript，Fetch。",
      ...
      {
        role: "学习中心内容底层改造",
        date: "2021年07月 — 2021年09月",
        bullets: [
          "【项目介绍】学习中心内容底层改造，支持前台场景灵活、产品化地组织课程。",
          "【技术栈】Vue，Vue Router，Vuex，Element UI，Ant Design，axios。",
